                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="admin_role" name="admin_role[]" multiple
                            ...
                            <option value="pj_diverso" {{ in_array('pj_diverso', old('admin_role', []), true) ? 'selected' : '' }}>PJ normal → pj_diverso</option>
                            <option value="pj_colaborador" {{ in_array('pj_colaborador', old('admin_role', []), true) ? 'selected' : '' }}>PJ do fluxo RH → pj_colaborador</option>
                            <option value="pf" {{ in_array('pf', old('admin_role', []), true) ? 'selected' : '' }}>PF → pf</option>
                        </select>
